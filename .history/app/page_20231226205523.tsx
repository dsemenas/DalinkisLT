...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-8">
      ...
      <div className="mt-16 text-center space-3">
        <h2 className="text-3xl">Naujausi nuomos pasiūlymai</h2>
        <div className="grid grid-cols-4 grid-wrows-auto gap-y-5 gap-x-5 w-full mt-2">
          {data
            ? data.products.map((product, index) => (
                <div
                  className="card card-compact w-96 bg-base-100 shadow-xl text-start"
                  key={index}
                >
                  <figure>
                    <img
