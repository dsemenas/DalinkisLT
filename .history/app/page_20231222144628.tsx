...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-start items-center gap-5 p-96 bg-white">
      <div className="flex justify-center items-center w-full max-w-5xl py-3 ps-5 pe-3 border border-2 rounded-full">
        <input
          type="text"
