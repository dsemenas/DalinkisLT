        ...
        <div className="grid grid-cols-4 grid-wrows-auto gap-y-5 gap-x-5 w-full mt-16">
          {data
            ? data.products.map((product, index) => (
                <div
                  className="card card-compact h-96 w-96 bg-base-100 shadow-xl text-start"
                  key={index}
                >
                  <figure>
                    <img
                  ...
                  <div className="card-body">
                    <div className="flex justify-between items-center sapce-y-2">
                      <h2 className="card-title truncate">
                        {product.title}kfahgfoiafiob
                      </h2>
                      <div className="block">
