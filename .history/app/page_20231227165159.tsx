        ...
        <div className="grid grid-cols-4 grid-wrows-auto gap-y-5 gap-x-5 w-full mt-16">
          {data
            ? data.products.map((product, index) => (
                <div
                  className="card card-compact h-96 w-96 bg-base-100 shadow-xl text-start cursor-pointer hover:border"
                  key={index}
                  onClick={() => {}}
                >
                  <figure>
                  ...
                  <div className="card-body">
                    <div className="prose flex justify-between items-center space-x-10">
                      <h1 className="card-title truncate">{product.title}</h1>
