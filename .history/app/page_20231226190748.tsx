...
export default function Home() {
  const [isFocused, setIs] = useState(false);
  ...
  return (
    <div className="flex flex-col justify-start items-center gap-5 py-8 gap-10">
      <div className="flex justify-center items-center w-full max-w-5xl py-3 px-5 border-2 rounded-full bg-white">
        <input
          type="text"
      ...
      <div className="grid grid-cols-2 grid-rows-auto gap-y-3 gap-x-16 mt-32">
