...
import fetc from "./hooks/useFetch";
...
export default function Home() {
  ...
  const newlyAddedProducts = fetchData("https://dummyjson.com/products");

  useEffect(() => {
    console.log(newlyAddedProducts);
  }, []);
  ...
  return (
    <div className="flex flex-col justify-start items-center py-8">
      ...
      <div className="mt-16 prose">
        ...
        <div className="grid grid-cols-4 grid-wrows-auto gap-y-3 gap-x-16 w-full mt-2"></div>
      </div>
    </div>
  );
}
